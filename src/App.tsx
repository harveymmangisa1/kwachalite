...
import QuoteDetail from '@/app/dashboard/quotes/[id]/page'; // Actually named QuotePage
...
import InvoiceDetail from '@/app/dashboard/invoices/[id]/page'; // Actually named InvoicePage
