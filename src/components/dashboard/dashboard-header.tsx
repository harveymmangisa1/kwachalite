...
export function DashboardHeader() {
  ...
  return (
    <div className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/80 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button 
                variant="ghost" 
                className="h-12 px-3 gap-3 rounded-2xl hover:bg-slate-50 transition-all group"
              >
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-slate-100 pl-4">
            {activeWorkspace === 'personal' ? (
              <AddTransactionSheet>
                <Button className="rounded-xl bg-slate-900 hover:bg-slate-800 text-white shadow-sm h-10">
              ...
              <div className="flex gap-2">
                ...
                <AddClientSheet>
                  <Button className="rounded-xl bg-indigo-600 hover:bg-indigo-700 h-10 shadow-indigo-100">
